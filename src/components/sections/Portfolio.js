    ...
    >
      ...
      >
        {Array.isArray(projects) && projects.map((project, index) => (
          <SwiperSlide className="single-item swiper-slide" key={index}>
            <div className="main-content">
              <img className="img-fluid" src={project.image.url} alt={project.title} />
            </div>
            <div className="details">
              <h4>{project.title}</h4>
              <div>
              ...
              <a href={project.liveurl} target="_blank" rel="noopener noreferrer" className="custom-btn">
                <span>
                  preview <i className="fa-solid fa-arrow-up-right-from-square" />
                </span>
              </a>
              <a href={project.githuburl} target="_blank" rel="noopener noreferrer" className="custom-btn">
                <span>
